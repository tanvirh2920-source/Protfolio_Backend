  ...
  const projects = [
    {
      ...
      description:
        "A full-stack e-commerce application with user authentication, product catalog, shopping cart, and Stripe payment processing.",
    ...
    },
    {
      ...
      description:
        "A Kanban-style task management application with drag-and-drop functionality and real-time updates via WebSockets.",
    ...
    },
    {
      ...
      description:
        "Real-time weather data visualization with interactive charts and 7-day forecasts.",
